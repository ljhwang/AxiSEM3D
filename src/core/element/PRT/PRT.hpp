...
class PRT {
  ...
  // copy constructor
  PRT(const PRT& other) :
      m1D(other.m1D), mX0(other.mX0), mX1(other.mX1), mX2(other.mX2), mX3(other.mX3),
      mXJ(other.mXJ) {
    // noting
  }
#else
  ...
  PRT(const PRT& other) :
      m1D(other.m1D), mX0(other.mX0), mX1(other.mX1), mX2(other.mX2), mX3(other.mX3),
      mX0_J(other.mX0_J), mX1_J(other.mX1_J), mX2_J(other.mX2_J), mX3_J(other.mX3_J) {
    // noting
  }
#endif
...
#endif
    for (int alpha = 0; alpha < nu_1; alpha++) {
      undulatedToSpherical3<CaseFA::_1D_FR>(und3, sph3, alpha, xX0_J, xX1_J, xX2_J, xX3_J);
    }
  }
...
#endif
    for (int alpha = 0; alpha < nu_1; alpha++) {
      undulatedToSpherical6<CaseFA::_1D_FR>(und6, sph9, alpha, xX0_J, xX1_J, xX2_J, xX3_J);
    }
  }
  ...
  sphericalToUndulated3_CD(const eigen::RMatXN3& sph3, eigen::RMatXN3& und3, int nr) const {
    if (m1D) {
      ...
      sphericalToUndulated3<CaseFA::_3D_CD>(sph3, und3, nr, mX0, mX1, mX2, mX3);
    }
  }
  ...
  sphericalToUndulated6_CD(const eigen::RMatXN9& sph9, eigen::RMatXN6& und6, int nr) const {
    if (m1D) {
      ...
      sphericalToUndulated6<CaseFA::_3D_CD>(sph9, und6, nr, mX0, mX1, mX2, mX3);
    }
  }
  ...
  sphericalToUndulated9_CD(const eigen::RMatXN9& sph9, eigen::RMatXN9& und9, int nr) const {
    if (m1D) {
      ...
      sphericalToUndulated9<CaseFA::_3D_CD>(sph9, und9, nr, mX0, mX1, mX2, mX3);
    }
  }
...
#endif
    if (m1D) {
      undulatedToSpherical3<CaseFA::_1D_CD>(und3, sph3, nr, xX0_J, xX1_J, xX2_J, xX3_J);
    } else {
      undulatedToSpherical3<CaseFA::_3D_CD>(und3, sph3, nr, xX0_J, xX1_J, xX2_J, xX3_J);
    }
  }
...
#endif
    if (m1D) {
      undulatedToSpherical6<CaseFA::_1D_CD>(und6, sph9, nr, xX0_J, xX1_J, xX2_J, xX3_J);
    } else {
      undulatedToSpherical6<CaseFA::_3D_CD>(und6, sph9, nr, xX0_J, xX1_J, xX2_J, xX3_J);
    }
  }
  ...
  undulatedToSpherical6_NoIntegration_CD(
    ...
    if (m1D) {
      ...
      undulatedToSpherical6<CaseFA::_3D_CD>(und6, sph9, nr, mX0, mX1, mX2, mX3);
    }
  }
  ...
  static void
  sphericalToUndulated3(const FMat3& sph3,
      FMat3& und3,
      int nx,
  ...
  static void
  sphericalToUndulated6(const FMat9& sph9,
      FMat6& und6,
      int nx,
      const faN::PropertyN& X0,
      const faN::PropertyN& X1,
    ...
    FA::F1abxP1_F2xP2_F3xP3<CASE>(nx, und6, 5, sph9, 3, 1, X0, 5, X1, 2, X2);
  }

  // solid, sph -> und, for curl computation (9->9)
  template <CaseFA CASE, class FMat9>
  static void
  sphericalToUndulated9(const FMat9& sph9,
      FMat9& und9,
      int nx,
      const faN::PropertyN& X0,
      const faN::PropertyN& X1,
  ...
  template <CaseFA CASE, class FMat3>
  static void
  undulatedToSpherical3(const FMat3& und3,
      FMat3& sph3,
      int nx,
      const faN::PropertyN& X0,
      const faN::PropertyN& X1,
  ...
  static void
  undulatedToSpherical6(const FMat6& und6,
      FMat9& sph9,
      int nx,
      const faN::PropertyN& X0,
      const faN::PropertyN& X1,
