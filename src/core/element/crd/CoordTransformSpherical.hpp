...
class CoordTransformSpherical : public CoordTransform {
  ...
  transformSPZ_RTZ3(eigen::vec_ar3_CMatPP_RM& ui, int nu_1) const {
    ...
    for (int alpha = 0; alpha < nu_1; alpha++) {
      ...
      ui[alpha][0] = (ui_alpha__0_.cwiseProduct(xCos1t) - ui[alpha][2].cwiseProduct(xSin1t));

      // rtz2 = spz2 * cos(t) + spz0 * sin(t)
      ui[alpha][2] = (ui[alpha][2].cwiseProduct(xCos1t) + ui_alpha__0_.cwiseProduct(xSin1t));
  ...
  transformSPZ_RTZ9(eigen::vec_ar9_CMatPP_RM& nij, int nu_1) const {
    ...
    for (int alpha = 0; alpha < nu_1; alpha++) {
      ...
      nij[alpha][0] = (s08 + d08.cwiseProduct(xCos2t) - s26.cwiseProduct(xSin2t)) * half;
      nij[alpha][2] = (d26 + s26.cwiseProduct(xCos2t) + d08.cwiseProduct(xSin2t)) * half;
  ...
  transformRTZ_SPZ6(eigen::vec_ar6_CMatPP_RM& sij, int nu_1) const {
    ...
    for (int alpha = 0; alpha < nu_1; alpha++) {
      ...
      sij[alpha][0] =
          ((s02 + d02.cwiseProduct(xCos2t)) * half + sij[alpha][4].cwiseProduct(xSin2t));
