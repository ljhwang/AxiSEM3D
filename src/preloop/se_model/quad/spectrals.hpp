...
namespace spectrals {
  ...
  namespace internal {
    ...
    const std::vector<double> wGLL = {+1.000000000000, +1.000000000000};
    const std::vector<double> wGLJ = {+0.666666666667, +1.333333333333};
    ...
    const std::vector<double> wGLL = {+0.333333333333, +1.333333333333, +0.333333333333};
    const std::vector<double> wGLJ = {+0.111111111111, +1.388888888889, +0.500000000000};
    const std::vector<double> gGLL = {-1.500000000000,
        -0.500000000000,
        +0.500000000000,
        +2.000000000000,
        +0.000000000000,
        ...
        +0.500000000000,
        +1.500000000000};
    const std::vector<double> gGLJ = {-1.333333333333,
        -0.333333333333,
        +0.333333333333,
        +2.083333333333,
        -0.416666666667,
    ...
    const std::vector<double> gGLL = {-3.000000000000,
        -0.809016994375,
        +0.309016994375,
        -0.500000000000,
        +4.045084971875,
        ...
        +0.809016994375,
        +3.000000000000};
    const std::vector<double> gGLJ = {-2.500000000000,
        -0.445902906223,
        +0.160188620509,
        -0.250000000000,
        +4.108757210636,
    ...
    const std::vector<double> pGLJ = {
        -1.000000000000, -0.507787629558, +0.132300820777, +0.708820142114, +1.000000000000};
    const std::vector<double> wGLL = {
        +0.100000000000, +0.544444444444, +0.711111111111, +0.544444444444, +0.100000000000};
    const std::vector<double> wGLJ = {
        +0.013333333333, +0.289656694561, +0.736004369482, +0.794338935957, +0.166666666667};
    const std::vector<double> gGLL = {-5.000000000000,
        -1.240990253031,
        +0.375000000000,
        -0.259009746969,
        +0.500000000000,
        ...
        +1.240990253031,
        +5.000000000000};
    const std::vector<double> gGLJ = {-4.000000000000,
        -0.616438928116,
        +0.168105664494,
        -0.107222291934,
        +0.200000000000,
    ...
    const std::vector<double> pGLL = {-1.000000000000,
        ...
        +0.765055323929,
        +1.000000000000};
    const std::vector<double> pGLJ = {-1.000000000000,
        -0.650778856692,
        -0.156370431808,
        +0.373489378736,
        +0.797296273400,
        +1.000000000000};
    const std::vector<double> wGLL = {+0.066666666667,
        +0.378474956298,
        +0.554858377035,
        +0.554858377035,
        +0.378474956298,
        +0.066666666667};
    const std::vector<double> wGLJ = {+0.006349206349,
        +0.150329375443,
        +0.452292685042,
        +0.685821572112,
        +0.590921446768,
        +0.114285714286};
    const std::vector<double> gGLL = {-7.500000000000,
        -1.786364948339,
        +0.484951047854,
        -0.269700610832,
        +0.237781177984,
        ...
        +1.786364948339,
        +7.500000000000};
    const std::vector<double> gGLJ = {-5.833333333333,
        -0.832247046049,
        +0.198615502767,
        -0.099070383168,
        +0.081562432334,
    ...
    const std::vector<double> pGLJ = {-1.000000000000,
        ...
        +0.850846569722,
        +1.000000000000};
    const std::vector<double> wGLL = {+0.047619047619,
        +0.276826047362,
        +0.431745381210,
        +0.487619047619,
        +0.431745381210,
        +0.276826047362,
        +0.047619047619};
    const std::vector<double> wGLJ = {+0.003401360544,
        +0.084736552956,
        +0.280303211939,
        +0.501646961918,
        +0.594575445079,
        +0.452003134230,
        +0.083333333333};
    const std::vector<double> gGLL = {-10.50000000000,
        -2.442926014244,
        +0.625256665515,
        -0.312500000000,
        +0.226099400943,
        ...
        +2.442926014244,
        +10.50000000000};
    const std::vector<double> gGLJ = {-8.000000000000,
        -1.090282836280,
        +0.241099171111,
        -0.105970006790,
        +0.069964084602,
    ...
    const std::vector<double> pGLJ = {-1.000000000000,
        ...
        +0.885688481784,
        +1.000000000000};
    const std::vector<double> wGLL = {+0.035714285714,
        +0.210704227144,
        +0.341122692484,
        +0.412458794659,
        +0.412458794659,
        ...
        +0.210704227144,
        +0.035714285714};
    const std::vector<double> wGLJ = {+0.001984126984,
        +0.051068915198,
        +0.179218780464,
        +0.353399617690,
        +0.490974910515,
        ...
        +0.355077615089,
        +0.063492063492};
    const std::vector<double> gGLL = {-14.00000000000,
        -3.209915703003,
        +0.792476681321,
        -0.372150435729,
        +0.243330712724,
        ...
        +3.209915703003,
        +14.00000000000};
    const std::vector<double> gGLJ = {-10.50000000000,
        -1.389476486679,
        +0.292862473417,
        -0.119295379021,
        +0.070042356542,
    ...
    const std::vector<double> pGLJ = {-1.000000000000,
        ...
        +0.909616131210,
        +1.000000000000};
    const std::vector<double> wGLL = {+0.027777777778,
        +0.165495361561,
        +0.274538712500,
        +0.346428510973,
        +0.371519274376,
        ...
        +0.165495361561,
        +0.027777777778};
    const std::vector<double> wGLJ = {+0.001234567901,
        +0.032489354604,
        +0.118611429028,
        +0.248991726162,
        +0.380501475574,
        ...
        +0.285487734745,
        +0.050000000000};
    const std::vector<double> gGLL = {-18.00000000000,
        -4.087013702034,
        +0.985360090075,
        -0.444613449281,
        +0.273437500000,
        ...
        +4.087013702034,
        +18.00000000000};
    const std::vector<double> gGLJ = {-13.33333333333,
        -1.729365450870,
        +0.352921826495,
        -0.136768251355,
        +0.074658577581,
