...
To install the package separately see the [installation intructions](https://github.com/AxiSEMunity/salvus_mesh_lite#installation) in the [salvus_mesh_lite repository](https://github.com/AxiSEMunity/salvus_mesh_lite).
